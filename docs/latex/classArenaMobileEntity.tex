...
\begin{center}
\leavevmode
\includegraphics[height=550pt]{classArenaMobileEntity__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classArenaMobileEntity__coll__graph}
\end{center}
\end{figure}
...
Since this is also a parent class, many of its methods are intuitively {\ttfamily virtual}. 
