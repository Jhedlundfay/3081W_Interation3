...
The parent class from which all \hyperlink{classArena}{Arena} entities inherit.  
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classArenaEntity__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=217pt]{classArenaEntity__coll__graph}
\end{center}
\end{figure}
...
void \hyperlink{classArenaEntity_aca125a42da21fd0d914b629be03ac040}{set\+\_\+intensity} (double intensity)\hypertarget{classArenaEntity_aca125a42da21fd0d914b629be03ac040}{}\label{classArenaEntity_aca125a42da21fd0d914b629be03ac040}

\begin{DoxyCompactList}\small\item\em the setter for the entities\textquotesingle{} intensities. The values used by the robots\textquotesingle{} sensors to determine how the robot should be moving. By making this property universal to all entities, the sensors are open to extension. \end{DoxyCompactList}\item 
double \hyperlink{classArenaEntity_aa803d961d3530f9e01ea920ab7c4ecb1}{get\+\_\+intensity} ()\hypertarget{classArenaEntity_aa803d961d3530f9e01ea920ab7c4ecb1}{}\label{classArenaEntity_aa803d961d3530f9e01ea920ab7c4ecb1}

\begin{DoxyCompactList}\small\item\em the getter for the entities\textquotesingle{} intensities. Used by the sensors to calculate the impulse based on distance from the entity. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\item Reset themselves to a newly constructed state. So that the user can click the reset button to restart the game. Alternatively, the game will be reset if the robot loss condition is met. There is no way to win.
\end{DoxyEnumerate}
