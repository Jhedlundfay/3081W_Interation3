...
class MotionHandler {
  ...
  */
  ...
  /**
   * @brief Decrease the speed of both wheels to zero immediately.
   */
  void KillSpeed();

  /**
   * @brief The Advancing behavior of the light: moves forward at a
   * set speed
   */
  void Advance();

  /**
   * @brief The Retreating behavior of the light: moves backwards in
   * an arc
   */
  void Retreat();

  /**
   * @brief Switch cases for dealing with impulses from sensor given the
   * behavior of the vehicle
   */
  void HandleImpulse(double impulse, int behavior, int side);
